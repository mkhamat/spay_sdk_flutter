...
class SberPayApi {
  ...
  Future<bool> initSberPay(InitConfig config) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.initSberPay$pigeonVar_messageChannelSuffix';
  ...
  Future<bool> isReadyForSPaySdk() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.isReadyForSPaySdk$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<SberPayApiPaymentStatus> pay(PaymentRequest request) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.pay$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
